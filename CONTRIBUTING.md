...
Corrections are never made directly to source files — they are expressed as change files applied by scripts. See [`CLAUDE.md`](https://github.com/sanskrit-lexicon/AP90/blob/main/CLAUDE.md) for the change-file format and the `updateByLine.py` workflow.
