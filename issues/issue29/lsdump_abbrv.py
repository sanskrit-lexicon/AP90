...
if __name__=="__main__":
 abbrev = sys.argv[1] # 
 dictlo = sys.argv[2]   
 filein = sys.argv[3] #  xxx.txt dictionary
 filetip = sys.argv[4] # tooltip file
 fileout = sys.argv[5] # all instances of abbrev in dictionary
