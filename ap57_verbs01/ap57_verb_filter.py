...
def mark_entries_verb(entries,exclusions,inclusions):
 ...
 for entry in entries:
  ...
  patterns = [
    u'Den[.] [AĀUP][.]', # denominative
    u'€[0-9, ]*[AĀUP][.]', # class pada  standard form with €
    u'[0-9, ]*[AĀUP][.]', # class pada  standard form without €
    u' [AĀUP][.]',   # pada only
    ' To ',
  ]
  codes = [None,None,None,None,None]
  pattern_codes = ['D','€','C','P','T']
  lex = False
 ...
 with codecs.open(fileout,"w","utf-8") as f:
  for ientry,entry in enumerate(entries):
   ...
   if False:
    ...
    outarr.append('%s: %s' %(code,entry.datalines[0]))
    outarr.append('')
...
if __name__=="__main__": 
 ...
 filein1 = sys.argv[2] # ap90_verb_exclude.txt
 filein2 = sys.argv[3] # ap90_verb_include.txt
 fileout = sys.argv[4] # 
